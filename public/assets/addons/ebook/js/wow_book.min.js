...
window.Modernizr = function (d, l, u) {
    ...
    function p(a, b, c) {
        var e = a.charAt(0).toUpperCase() + a.substr(1), f = (a + " " + A.join(e + " ") + e).split(" ");
        if ("string" === typeof b || "undefined" === typeof b)b = w(f, b); else a:{
            f = (a + " " + B.join(e + " ") + e).split(" "), a = f;
    ...
    var g = {}, s = l.documentElement, n = l.createElement("modernizr"), z = n.style;
    d = " -webkit- -moz- -o- -ms- ".split(" ");
    var A = ["Webkit", "Moz", "O", "ms"], B = ["webkit", "moz", "o", "ms"], n = {}, a = [], c = a.slice, b, e = function (a, b, c, e) {
            var f, d, k, h = l.createElement("div"), p = l.body, g = p ? p : l.createElement("body");
            if (parseInt(c, 10))for (; c--;)k = l.createElement("div"), k.id = e ? e[c] : "modernizr" + (c + 1), h.appendChild(k);
            return f = ["&#173;<style>", a, "</style>"].join(""), h.id = "modernizr", (p ? h : g).innerHTML += f, g.appendChild(h), p || (g.style.background = "", s.appendChild(g)), d = b(h, a), p ? h.parentNode.removeChild(h) : g.parentNode.removeChild(g), !!d
        }, f = {}.hasOwnProperty,
        k;
    ...
    Function.prototype.bind || (Function.prototype.bind = function (a) {
        ...
        var e = c.call(arguments, 1), f = function () {
            if (this instanceof f) {
                var d = function () {
                };
                d.prototype = b.prototype;
                var d = new d, k = b.apply(d, e.concat(c.call(arguments)));
    ...
    n.csstransforms3d = function () {
        var a = !!p("perspective");
        return a && "webkitPerspective" in s.style && (a = g.csstransforms3d), a
    };
    for (var h in n)k(n, h) && (b = h.toLowerCase(), g[b] = n[h](), a.push((g[b] ? "" : "no-") + b));
    z.cssText = "";
    return n = null, g._version = "2.5.3", g._prefixes = d, g._domPrefixes = B, g._cssomPrefixes = A, g.testProp = function (a) {
        return w([a])
    }, g.testAllProps = p, g.testStyles = e, g.prefixed = function (a, b, c) {
...
(function (d, l, u) {
    ...
    "$:nomunge";
    var p = "hashchange", g = document, s, n = d.event.special, z = g.documentMode, A = "on" + p in l && (z === u || 7 < z);
    d.fn[p] = function (d) {
    ...
    s = function () {
        function n() {
            var a = w(), e = k(b);
            a !== b ? (f(b = a, e), d(l).trigger(p)) : e !== b && (location.href = location.href.replace(/#.*/,
                    "") + e);
            c = setTimeout(n, d.fn[p].delay)
        }

        var a = {}, c, b = w(), e = function (a) {
            return a
        }, f = e, k = e;
        a.start = function () {
            c || n()
        ...
        d.browser.msie && !A && function () {
            ...
            f = function (a, c) {
                var e = b.document, f = d.fn[p].domain;
...
(function (d) {
    function l(a, c) {
        ...
        f = this.pagesContainer = this.origin = d("<div class='wowbook-origin'></div>").css({position: "absolute"}).appendTo(a);
        ...
        b.shadowClipper = d(".wowbook-shadow-clipper", f).css({display: "none"});
        ...
        b.hardPageShadow = d("<div class='wowbook-hard-page-shadow'></div>").css({display: "none"}).appendTo(f);
        ...
        c.curl && d(".wowbook-handle", f).hover(function (a) {
            if (!b.curlTimer) {
                ...
                if (c) {
                    var e = c.offset(), f = a.pageY - e.top;
        ...
        if (this.opts.keyboardNavigation)d(document).on("keydown.wowbook", function (a) {
            d(a.target).filter("input, textarea, select").length || (a.which === b.opts.keyboardNavigation.back && b.back(), a.which === b.opts.keyboardNavigation.advance &&
            b.advance())
        });
        d(window).on("hashchange.wowbook", function () {
            var a = window.location.hash;
            if (a === b.locationHashSetTo)b.locationHashSetTo = void 0; else {
        ...
        this.mouseWheel && a.mousewheel(function (a, c) {
            if (b.mouseWheel)return "zoom" === b.mouseWheel ? (0 < c && b.zoomIn(), 0 > c && b.zoomOut(), b.zoomedAt(a)) : (0 < c && b.advance(), 0 > c && b.back()), !1
        });
    ...
    function u(a, c) {
        var b = Math.cos(c), e = Math.sin(c);
        return {x: b * a.x - e * a.y, y: e * a.x + b * a.y}
    }

    function w(a) {
        var c = d(window).height(), b = a.offset(), e = d(window).scrollTop();
    ...
    function p(a, c, b) {
        ...
        if (!d.wowBook.support.boxSizing) {
            ...
            k = "none" == a.css("borderBottomStyle") ? 0 : s[m = a.css("borderBottomWidth")] ||
            parseFloat(m);
    ...
    l.prototype = {
        destroy: function () {
            ...
            this.currentScale = 1;
            var b = this.elem, e = this.pageWidth;
            b.css({height: c, width: a});
            var f = b.height();
            ...
            var k = this.origin.css({width: "100%", height: f});
            if (e && this.centeredWhenClosed) {
                var h = parseFloat(k.css("left"), 10);
                k.css("left", h / (e / this.pageWidth))
            }
            this.bookShadow.css({width: a, height: c});
            for (var h = 0, m = this.pages.length; h <
            m; h++)this.pages[h].css({
                width: this.pageWidth,
                height: this.pageHeight,
                left: this.pages[h].onLeft ? 0 : this.pageWidth
            }), e = d(".wowbook-page-content", this.pages[h]), p(e, this.pageWidth, this.pageHeight);
            this.opts.gutterShadow && d(".wowbook-gutter-shadow", b).css("height", this.pageHeight);
            this.positionBookShadow();
            this.shadowClipper.css({width: b.width(), height: f});
            ...
            this.clipBoundaries && (k = Math.ceil(Math.sqrt(this.pageWidth * this.pageWidth + this.pageHeight * this.pageHeight)), k = [this.pageHeight - k, b.width(), k, 0], this.origin.css("top", -k[0]), d(".wowbook-inner-clipper", b).css({
                ...
                height: k[2] - k[0],
                top: k[0]
            }), this.clipper.css({width: "100%", height: f}));
            this.zoomWindow.css({width: 2 * this.pageWidth, height: f});
            this.zoomContent.css({width: 2 * this.pageWidth, height: f});
            this.corners = {
                tl: [0, 0], bl: [0, this.pageHeight],
                tr: [this.pageWidth, 0], br: [this.pageWidth, this.pageHeight], l: [0, 0], r: [this.pageWidth, 0]
            };
            ...
            e; b++)this.insertPage(a[b], !0);
            this.updateBook(c)
        }, insertPage: function (a, c) {
            if (this.isDoublePage(a))this.insertDoublePage(a, c); else {
            ...
            if (!this._insertingDoublePage) {
                ...
                var b = d(a), e = b.clone().insertAfter(b), f = b.add(e);
                b.css("left", 0);
                e.css("right", "100%");
            ...
            for (var c = this.rtl, b, e = 0, f = this.pages.length; e < f; e++) {
                ...
                b.image = this.replaceNumberHolder(k.data("image") || this.opts.images, e);
            ...
            var a = this.opts;
            if (a.pageNumbers) {
                var c = a.numberedPages, a = this.pages.length - 1, b = this.pageIsOnTheLeft(a);
                "all" == c && (c = [0, -1]);
                c || (c = [2, b ? -3 : -2]);
                var e = c[0], c = c[1];
                0 > e && (e = a + e + 1);
            ...
            f = a.hardPages || [];
            var d = !0 === f;
            if (!d)for (a.hardcovers && (f.push(0, 1, -1), this.pageIsOnTheLeft(this.pages.length - 1) && f.push(-2)), a = 0, e = f.length; a < e; a++)b = f[a], 0 > b && (b = this.pages.length + b), 0 <= b && b < this.pages.length && (c[b] = !0);
            ...
            var b = this.leftPageIndex(a), e = this.rightPageIndex(a),
                f = this.pageBelow(b), k = this.pageBelow(e), h = this.pageWidth, m = this.rtl, v = this.pages.length - 1, p, g;
            this.loadPage(b);
            this.loadPage(e);
            this.loadPage(f);
            this.loadPage(k);
            ...
            for (var t = 0; t <= v; t++)p = this.pages[t].onLeft != this.rtl ? t : v - t, g = this.transparentPages ? m ? t <= b ? "block" : "none" : t >= e ? "block" : "none" : t === f || t === b || t === e || t === k ? "block" : "none", this.pages[t].data("zIndex", p).css({
                display: g,
            ...
            this.currentPage = a;
            this.centeredWhenClosed && (b = !!this.leftPage(a), e = this.rightPage(a), this.origin.css("left",
                b && e ? 0 : b ? h / 2 : -h / 2));
            this.positionBookShadow();
            ...
            "number" === typeof a && (a = this.pages[a]);
            if (a) {
                var d = a.pageIndex, h = this.pages.length - 1, m = !this.otherPage(h);
                if (!e)e = this.pageIsOnTheLeft(d) ? "l" : "r"; else if (!this.corners[e] || (this.pageIsOnTheLeft(d) ? /r/ : /l/).test(e))return;
                ...
                if (f) {
                    ...
                    if (this.centeredWhenClosed && (0 === d || 0 === v || m && (v === h || d === h))) {
                        var p = 0, g, t = !this.rtl, q = this.pageWidth, r, n, l, u, s, w, z, A;
                        if (t ? 0 === d : d === h && m)r = -q / 2, n = -q / 4, l = 0, u = -q / 2, s = -q, w = n, z = s, A = c;
                        if (t ? d === h && m : 0 === d)r = q, n = 3 * q / 2, l = q / 2, u = 0, s = q, w = 2 * q, z = c, A = w;
                        if (t ? 0 === v : v === h && m)r = q / 2, n = d === (t ? h : 0) ? q : 3 * q / 2, l = d === (t ? h : 0) ? q / 2 : 0, u = -q / 2, s = r, w = 2 * q, z = c, A = w;
                        if (t ? v === h && m : 0 === v)r = d === (t ? 0 : h) ? 0 : -q / 2, n = q / 2, l = q / 2, u = d === (t ? 0 : h) ? -q / 2 : 0, s = -q, w = n, z = s, A = c;
                        c < r && (p = l, g = z);
                        c > n && (p = u, g = A);
                        c >= r &&
                        c <= n && (c = (c - r) / (n - r), p = l + c * (u - l), g = s + c * (w - s));
                        c = g;
                    ...
                    if (!a.data("holded") && (a.addClass("wowbook-page-holded"), f.addClass("wowbook-page-holded"), a.data("holded", !0), this.holdedPage = a, this.holdedPageBack = f, this.shadows && this.shadowClipper.css("display", "block"), this.clipBoundaries &&
                        this.clipper.css("overflow", "visible"), this.positionBookShadow(), this.opts.onHoldPage))this.opts.onHoldPage(this, d, a, f)
                }
            }
            ...
            if (f && f.length) {
                ...
                var h = this.pageWidth, m = this.pageHeight;
                e || (e = "tl");
                if ("l" == e || "r" == e) {
                    var v = {x: "l" == e ? 0 : h, y: b};
                    a.data("grabPoint", v);
                ...
                f.css({left: d.pageLeft + "px", zIndex: 1E3, clip: "rect(-1000px 2000px 2000px 0px)"});
                d.shadowHeight = 2 * Math.ceil(d.pageDiagonal);
                d.shadowTop = -(d.shadowHeight - m) / 2;
                this.internalShadow.css({display: "block", height: d.shadowHeight});
                d.foldShadowWidth = this.foldShadow.width();
                this.foldShadow.css({display: "block", height: d.shadowHeight});
            ...
            var c = this.pageWidth, b = this.pageHeight, e = c / 2, f = b / 2, k = d.wowBook.utils.translate, h = a.pageLeft, m = a.x, v = a.y, p = a.back, g = a.corner || "tl";
            if ("l" == g || "r" == g) {
                var t = a.page.data("grabPoint");
                t || (t = {x: "l" == g ? 0 : c, y: v}, page.data("grabPoint", t));
                g = (v >= t.y ? "t" :
                        "b") + (this.pageIsOnTheLeft(a.pageIndex) ? "l" : "r");
                a.corner = g;
                a.page.data("holdedCorner", g);
                var q = m - t.x, r = v - t.y, q = Math.atan2(r, q), t = {
                    x: 0,
                    y: (v >= t.y ? 0 : b) - t.y
                }, t = u(t, 2 * q), m = t.x + m, v = t.y + v
            }
            a.page.data("holdedAt", {x: m, y: v});
            a.page.data("holdedCorner", g);
            var t = this.corners[g], g = c - t[0], n = t[1], q = m - g, r = v - n, l = Math.sqrt(q * q + r * r);
            l > c && (m = g + c * q / l, v = n + c * r / l);
            var n = b - n, q = m - g, r = v - n, l = Math.sqrt(q * q + r * r), s = a.pageDiagonal;
            ...
            if (this.shadows && 0 < s) {
                ...
                this.shadowContainer.css({opacity: s, display: "block"})
            ...
            l = s.x - m + e - 1;
            b = {x: s.x - m, y: s.y + m * r};
            h = {x: s.x - m, y: s.y - m / (0 == r ? 1E-4 : r)};
            b = u(b, -v);
            h = u(h, -v);
            h = -(h.x + e);
            b = -(b.y - f);
            a.backContent.css("transform", k(-l, 0) + " rotate(" + q + "deg)");
            a.back.css("transform", k((g + h + Math.cos(v) * l).toFixed(5), (t - b + Math.sin(v) * l).toFixed(5)) +
                " rotate(" + q + "deg)");
            ...
            if (d && d.length) {
                ...
                this.shadows &&
                this.hardPageShadow.css("display", "block");
                return k
            }
        }, flipHardPageStyles: function (a) {
            var c = a.page, b = a.back;
            x = a.x;
            y = a.y;
            var e = this.pageIsOnTheRight(a.pageIndex), f = this.pageWidth, k = this.pageHeight;
            (a = a.corner) || (a = "tl");
            c.data("holdedAt", {x: x, y: y});
            ...
            if (this.opts.use3d && Modernizr.csstransforms3d) {
                ...
                a.css({
                    transform: "perspective(" + this.opts.perspective + this.perspectiveUnit + ") rotate3d(0, 1, 0, " +
                    g + "deg)", display: "block"
                })
            } else a.css({transform: "skewY(" + h + "rad) scaleX(" + e + ")", display: "block"});
            ...
            this.shadows && this.hardPageShadow.css({left: c ? 0 : f, opacity: 0.5 * Math.abs(b / f)})
        }, _calculateAngleFromX: function (a, c, b) {
            var e = 2 * c / 3;
            if (a > e) {
                var d =
                    this._calculateAngleFromX(e, c, b);
        ...
        foldPageBasicStart: function (a, c, b, e, d) {
            ...
            if (d && d.length) {
                ...
                this.foldGradientElem.css({left: 0, height: h}).toggleClass("wowbook-fold-gradient-flipped", a.onRight);
                return k
            }
            ...
            x = a.x;
            y = a.y;
            var d = this.pageWidth, f = a.corner;
            f || (f = "tl");
            c.data("holdedAt", {
                x: x,
                y: y
            ...
            c.css("clip", m);
            b.css({clip: g, left: k, display: "block"});
            c = this.calculateOpacity(2 * h, 2 * d, this.shadowThreshold, 50);
            this.shadows && 0 < c ? (b = f ? h - a.foldShadowWidth : d - h + d, this.shadowContainer.css("opacity",
                c), this.foldShadow.css({left: b, display: "block"})) : this.foldShadow.css("display", "none");
            ...
            if (!f.animating) {
                ...
                b.data("holdedAt");
                var h = e.corner || b.data("holdedCorner"), m = d.easing[e.easing] || e.easing || function (a) {
                ...
                !b.isHardPage && 0.4 < a.duration / this.turnPageDuration && this.playFlipSound();
                this.currentFlip = a
            }
        }, rafCallback: function () {
            window.raf(this.callRAFCallback);
            if (this.currentFlip && !this.currentFlip.finished) {
                var a = this.currentFlip, c = (d.now() - a.start) / a.duration;
                1 <= c && (c = 1);
                ...
                a.dragging && (a.x = a.initialX + 0.2 * a.deltaX, a.y = a.initialY + 0.2 * a.deltaY, a.initialX = a.x, a.initialY = a.y,
                    a.deltaX = a.finalX - a.initialX, a.deltaY = a.finalY - a.initialY, 1 > a.deltaX && 1 > a.deltaY && 1 == c);
            ...
            "number" === typeof a && (a = this.pages[a]);
            var f = this, k = a.data("holdedAt"), h = a.data("holdedCorner");
            if (c && k)this.flip({
                from: [k.x, k.y], to: this.corners[h], page: a, easing: "linear", duration: 1E4,
                duration: d, complete: function () {
                    ...
                    foldPageBasic: null,
                    holded: !1
                }), this.clipBoundaries && !this.zoomed && (this.clipper.css("overflow", "hidden"), this.clipper.children(".wowbook-inner-clipper").css("overflow", "hidden")), this.shadowClipper.css("display", "none"), this.internalShadow.parent().hide(),
                    this.foldGradientContainer.hide(), this.hardPageShadow.hide(), this.resetPage(a), b && b.length && (this.resetPage(b), b.hide()), this.foldShadow.removeClass("wowbook-shadow-fold-flipped").css({
                    transform: "",
                    left: ""
            ...
            var c = this.pageWidth, b = this.pageHeight;
            ...
            var b, d;
            if (!this.animating &&
                (this._cantStopAnimation = !0, "string" === typeof a && "#" == a.charAt(0) && (a = this.selectorToPage(a)), 0 > a && (a = 0), a > this.pages.length - 1 && (a = this.pages.length - 1), !this.isOnPage(a))) {
                var f = a < this.currentPage;
                b = this.rtl ? a > this.currentPage : f;
                var k = this, h = b ? k.leftPage() : k.rightPage();
                if (h) {
                    this.uncurl(!0);
                    var m, g;
                    b ? (m = this.leftPage(a), g = this.rightPage(a)) : (m = this.rightPage(a), g = this.leftPage(a));
                    var p = g && g.is(":visible");
                    if (f)for (f = h.pageIndex - 1; 0 <= f; f--)this.pages[f].css("display", "none"); else for (f = h.pageIndex +
                        1, d = this.pages.length; f < d; f++)this.pages[f].css("display", "none");
                    ...
                    if (this.centeredWhenClosed && (h.isHardPage || g.isHardPage)) {
                        var q = this.pages.length - 1, r = !this.rtl, n = "easeOutCubic";
                        this.currentPage == (r ? 0 : q) &&
                        (b += this.pageWidth / 2, r ? a == q && this.pageIsOnTheLeft(a) : 0 == a) && (b += this.pageWidth / 2);
            ...
            this.slideShowTimer = setTimeout(function () {
                c.animating || c.holdedPage ?
                    c.advanceAfterTimeout(100) : (c.advance(), c.isOnPage(c.pages.length - 1) ? c.stopSlideShow() : c.advanceAfterTimeout(c.slideShowDelay + c.turnPageDuration))
            }, a)
            ...
            if (d.isArray(c)) {
                for (var e = 0, f = c.length; e < f; e++) {
                    ...
                    void 0 !== b[2] && a.push({id: b[0], title: b[1], page: b[2]})
                }
            ...
            for (var c = this.sections, b, d = 0, f = c.length; d < f && !(c[d].page > a); d++)b =
                c[d];
            return b
        }, currentSection: function () {
            return this.pageToSection(this.currentPage)
        }, fillToc: function (a, c) {
            var b = d(a || this.opts.toc), e, f, k = "";
            if (0 !== b.length) {
                e = this.sections;
                "undefined" === typeof c && (c = this.opts.tocTemplate);
                c || (k = b.is("UL, OL") ? "<li>" : "<div>", c = '<a href="${link}">${section}</a>');
                for (var h = 0, g = e.length; h < g; h++)f = e[h], f = c.replace(/\$\{link\}/g, "#" + this.id + "/" + f.id.substr(1)).replace(/\$\{section\}/g, f.title).replace(/\$\{page\}/g, f.page), d(f).appendTo(b).wrap(k)
            }
            ...
            if (a !== this.zoomLevel) {
                this.zoomLevel = a;
                var e = this, c = this.zoomWindow, b = this.zoomContent, f = d(this.zoomBoundingBox), k = 2 * e.pageWidth *
                    a * this.currentScale, h = e.pageHeight * a * this.currentScale, g = f.width(), p = f.height(), l = Math.min(k, g), n = Math.min(h, p), s = (2 * this.pageWidth * this.currentScale - l) / 2, q = (this.pageHeight * this.currentScale - n) / 2;
                c.css({width: l, height: n, left: s, top: q});
                this.zoomContentOverflowed = k > g || h > p;
                var r = c.offset(), f = f[0] !== window ? f.offset() : {left: f.scrollLeft(), top: f.scrollTop()};
                r.right = r.left + l;
                r.bottom = r.top + n;
                f.right = f.left + g;
                f.bottom = f.top + p;
                r.left < f.left && c.css("left", s + (f.left - r.left));
                r.right > f.right && c.css("left",
                    s + (f.right - r.right));
            ...
            if (this.zoomContentOverflowed) {
                var c = this.zoomLevel, b = this.zoomWindow.offset(), d = a.pageX - b.left;
                a = a.pageY - b.top;
                var f = this.zoomWindow.width(), b = 2 * this.pageWidth *
                    c * this.currentScale - f, d = d / f, f = this.zoomWindow.height(), g = this.pageHeight * c * this.currentScale - f;
                adjust = this.opts.zoomUsingTransform ? 1 : c;
                this.zoomContent.css({marginLeft: -b * d / adjust, marginTop: a / f * -g / adjust})
            }
        ...
        positionBookShadow: function () {
            var a = this.pages.length, c = !(!this.opts.bookShadow || this.zoomed || !a || 3 > a && this.holdedPage);
            this.bookShadow.toggle(c);
            if (c) {
                var c = this.pageWidth, b = this.holdedPageBack, d = !!b && b.onRight && b.pageIndex == (this.rtl ? a - 1 : 0);
                ...
                noPageOnLeft && noPageOnRight ? this.bookShadow.hide() : (a = this.opts.zoomUsingTransform ?
                    this.currentScale : 1, this.bookShadow.css({
            ...
            a.elem.bind("touchstart.wowbook", function (c) {
                ...
                a.pageEdgeDragStart(a._untouch(c)))
            });
            d(document).on("touchmove.wowbook", function (c) {
                if (a._touchStarted) {
                    var b = c.originalEvent.touches;
                    a._touchEnded = {x: b[0].pageX, y: b[0].pageY, timestamp: c.originalEvent.timeStamp};
            ...
            d(document).on("touchend.wowbook touchcancel.wowbook", function (c) {
                if (a._touchStarted) {
                    ...
                    var b = a._touchStarted, e = a._touchEnded || a._touchStarted;
                    a._touchStarted = null;
                    a._touchEnded = null;
                    if (b.inHandle)return a.pageEdgeDragStop({pageX: e.x}), !1;
                    c = e.x - b.x;
            ...
            this.flip(b, a, this.pageGrabbed, {corner: e});
            ...
            if (!this.curledPage && !this.holdedPage) {
                ...
                if (a && !a.isCurled) {
                    a.isCurled = !0;
                    this.curledPage = a;
                    var b = this.pageIsOnTheLeft(a.pageIndex), d = b ? 0 : this.pageWidth, f = c ? this.pageHeight - 1 : 2;
                    this.flip({
                        from: [d, f],
            ...
            var e = this, f = a.thumbnailsVertical ? "height" : "width";
        ...
        thumbnailConfig: function () {
            var a = {}, c = d('<div class="wowbook-thumbnail" style="display:none;position:absolute;line-height:0px;font-size:0px;">').prependTo(this.thumbnailsContainer), b = this.opts.thumbnailHeight || (2 >= c.height() ? 0 : c.height()), e = this.opts.thumbnailWidth || c.width(), f = e / this.pageWidth || b / this.pageHeight || this.opts.thumbnailScale;
            c.remove();
            ...
            var b = this.opts.thumbnailsVertical, d = b ? "height" : "width", f = {}, g = this.thumbnailsClipper[d](), d = -this.thumbnailsList[d]() + g;
            a < d && (a = d);
            0 < a && (a = 0);
            ...
            if (this.thumbnails && this.thumbnailsContainer.is(":visible")) {
                ...
                var b = this.opts.thumbnailsVertical, d = b ? "top" : "left", f = b ? "height" : "width", g = this.thumbnails[a], h = this.thumbnailsClipper, b = h[f]() / 2 - g[f]() / (b ? 2 : 1), d = g.offset()[d] - h.offset()[d];
    ...
    d.wowBook.defaults = {
        ...
        flipSoundPath: "/assets/addons/ebook/sound/",
    ...
    var g = d.browser.msie && 9 > d.browser.version ? 1 : 0, s = {
        thin: 2 - g,
        medium: 4 - g,
        thick: 6 - g
    }, n = window.document, z = n.documentElement, A = z.requestFullscreen || z.mozRequestFullScreen || z.webkitRequestFullscreen || z.msRequestFullscreen, B = n.exitFullscreen || n.mozCancelFullScreen || n.webkitExitFullscreen ||
        n.msExitFullscreen;
    d.wowBook.utils = {
...
(function (d) {
    function l(p) {
        var g = p || window.event, l = [].slice.call(arguments, 1), n = 0, u = 0, w = 0;
        p = d.event.fix(g);
        p.type = "mousewheel";
    ...
    if (d.event.fixHooks)for (var w = u.length; w;)d.event.fixHooks[u[--w]] =
        d.event.mouseHooks;
    d.event.special.mousewheel = {
        setup: function () {
            if (this.addEventListener)for (var d = u.length; d;)this.addEventListener(u[--d], l, !1); else this.onmousewheel = l
        }, teardown: function () {
            if (this.removeEventListener)for (var d = u.length; d;)this.removeEventListener(u[--d], l, !1); else this.onmousewheel = null
        }
    };
    d.fn.extend({
...
(function (d) {
    ...
    if (d.cssHooks) {
        var u = document.createElement("div"), w = ["O", "ms", "Webkit", "Moz"];
        l("transform");
        l("transformOrigin");
        l("boxSizing");
        l("zoom");
        ...
        d.each(["transform", "transformOrigin"], function (l, g) {
            d.wowBook.support[g] &&
            d.wowBook.support[g] !== g && !d.cssHooks[g] && (d.cssHooks[g] = {
                get: function (l, n, p) {
        ...
        d.wowBook.applyAlphaImageLoader = function (l) {
            var g, s, n, u, w = "", B = d("<div style='display:none'></div>").appendTo("body");
            s = 0;
