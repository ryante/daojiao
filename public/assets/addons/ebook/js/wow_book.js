        ...
        gotoPage: function (a, c) {
            ...
            if (!this.animating && (this._cantStopAnimation = !0, "string" === typeof a && "#" == a.charAt(0) && (a = this.selectorToPage(a)), 0 > a && (a = 0), a > this.pages.length - 1 && (a = this.pages.length - 1), !this.isOnPage(a))) {
                ...
                if (h) {
                    ...
                    //if($.isNumeric(m.children().data("bookid"))){
                    //    bookid.push(m.children().data("bookid"));
                    //}
                    //if($.isNumeric(g.children().data("bookid"))){
                    //    bookid.push(g.children().data("bookid"));
                    //}
                    //var bookidstr = bookid.join();
                    //$('#bookid').val(bookidstr);
                    var l = a;
                    m = h.data("holdedAt");
                    p = h.data("holdedAt");
